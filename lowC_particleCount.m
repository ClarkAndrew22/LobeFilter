...
run = {'Low Conc 1','Low Conc 2','Low Conc 3'};
...
%     clc;
    ...
    for jj = 1:3
        ...
        in_red_comp = imcomplement(inlet_red_bw); % remove spectral overlap
        inlet_green = inlet_im(:,:,2);
        inlet_green_bw = imbinarize(inlet_green,.3);
        inlet_green_bw = bwareaopen(inlet_green_bw,3);
        inlet_green_bw = logical(inlet_green_bw.*in_red_comp);
